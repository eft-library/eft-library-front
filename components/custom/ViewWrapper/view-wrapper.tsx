...
export default function ViewWrapper({ children }: ViewWrapperTypes) {
  return (
    <div className="flex flex-col min-h-screen dark:bg-[#1e2124] dark:text-white bg-gray-50 text-gray-900 relative">
      {/* 왼쪽 광고 */}
      <aside className="hidden 2xl:block fixed top-1/2 left-4 z-9900 -translate-y-1/2">
        <div className="sticky top-20">
          <div className="w-45 h-155 flex items-center justify-center">
            <AdBanner
      ...
      {/* 오른쪽 광고 */}
      <aside className="hidden 2xl:block fixed top-1/2 right-4 z-9900 -translate-y-1/2">
        <div className="sticky top-20">
          <div className="w-45 h-155 flex items-center justify-center">
            <AdBanner
              dataAdFormat={"vertical"}
