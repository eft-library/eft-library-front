...
export default function ProgressItem({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-linear-to-r from-emerald-500/5 via-blue-500/5 to-purple-500/5 dark:from-emerald-400/10 dark:via-blue-400/10 dark:to-purple-400/10 opacity-0 group-hover/item:opacity-100 transition-opacity duration-300" />

      <div className="relative flex flex-col items-center gap-2">
        <div className="relative aspect-square w-full overflow-hidden rounded-xl border border-gray-200/50 dark:border-gray-700/50 bg-linear-to-br from-gray-50 to-gray-100/50 dark:from-gray-800 dark:to-gray-700/50">
          ...
          {isInclude && (
            <div className="absolute inset-0 flex items-center justify-center backdrop-blur-sm bg-black/10 dark:bg-black/30">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-linear-to-r from-emerald-500 to-green-500 shadow-lg shadow-emerald-500/50">
