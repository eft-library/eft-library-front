...
export default function PrivacyPolicyEn() {
  return (
    <ContentsWrapper>
      ...
      <div className="p-4">
        <p>
          <strong>EFT Library</strong> places great importance on the protection
          of customer personal information and complies with the relevant laws
          and regulations that information and communications service providers
          must adhere to, such as the Act on Promotion of Information and
          Communications Network Utilization and Information Protection and the
          Personal Information Protection Act. Based on this, we have
          established the following privacy policy to inform you of how your
          personal information is used and what measures are being taken to
          protect it.
        </p>
        <p className="mt-4">
        ...
        <p className="mt-2">
          ...
          personal information provided online is protected while users use the
          company&lsquo;s services. The company complies with the personal
        ...
        <p className="mt-2">
          ...
          &quot;Agree&quot; or &quot;Cancel&quot; button for the contents of the
          company&lsquo;s privacy policy or terms of use. If the
        ...
        <p className="mt-2">
          ...
          living individual that can identify a specific individual by the name,
          date of birth, etc., included in the information.
        </p>
        <p className="mt-2">
        ...
        <p className="mt-2">
          ...
          to protect users&lsquo; personal information:
        </p>
        <p className="mt-2 pl-4">
