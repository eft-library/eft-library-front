      ...
      <div className="flex flex-col justify-between items-center gap-10 my-10">
        ...
        <div className="p-4">
          <p>
            ...
            Protection and the Personal Information Protection Act. Based on
            this, we have established the following privacy policy to inform you
            of how your personal information is used and what measures are being
            taken to protect it.
          </p>
          <p className="mt-4">
            This privacy policy may change according to changes in laws or
            guidelines, or changes in our policy. Members are encouraged to
            check our site regularly for updates.
          </p>
          ...
          <p className="mt-2">
            <strong>EFT Library</strong> is a site that provides guide
            information for the Escape from Tarkov game. Users can enjoy the
            game more effectively through various guides, weapon and equipment
            information, and community forums. The personal information
            collected on the site is used only for providing these services and
          ...
          <p className="mt-2">
            ...
            members and the purposes for collection and use are as follows:
          </p>
          ...
          <p className="mt-2 pl-4">
            <strong>Optional items:</strong> Address, verification procedures
            for membership services, IP address.
          </p>
          ...
          <p className="mt-2">
            The company continuously retains and uses the personal information
            of users while they are members of the company to provide services.
            However, if a user requests withdrawal or the purpose of collection
            is achieved, the company will promptly destroy the personal
            information.
          </p>
          <p className="mt-2">
            In accordance with the law, the company retains member information
            for a certain period if it is required by law, or if necessary for
            litigation or dispute resolution:
          </p>
          <p className="mt-2 pl-4">
            - If necessary for retention according to the Commercial Act or
            other laws
            <br />
            - If necessary for retention in anticipation of litigation or
            disputes
          ...
          <p className="mt-2 pl-4">
            ...
            using a technical method that makes recovery impossible, and
          ...
          <h2 className="mt-6 text-lg font-semibold">
            13. Contact Information of the Personal Information Protection
            Officer and Staff
          </h2>
          <p className="mt-2">
