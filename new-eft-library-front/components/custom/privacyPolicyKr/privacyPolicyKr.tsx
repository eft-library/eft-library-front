    ...
    <ContentsWrapper>
      <div className="flex flex-col justify-between items-center gap-10 my-10">
        ...
        <div className="p-4">
          ...
          <h2 className="mt-6 text-lg font-semibold">총칙</h2>
          <p className="mt-2">
            <strong>‘EFT Library’</strong>(이하 “회사”라 합니다) 이용자들의
            개인정보 보호를 매우 중요시하며, 이용자가 회사의 서비스를 이용함과
            동시에 온라인상에서 회사에 제공한 개인정보가 보호받을 수 있도록
            최선을 다하고 있습니다. 이에 회사는 정보통신망 이용촉진 및 정보보호
            등에 관한 법률 등 정보통신서비스제공자가 준수하여야 할 관련 법규상의
            개인정보 보호 규정 및 지침을 준수하고 있습니다.
          </p>

          <h2 className="mt-6 text-lg font-semibold">1. 앱의 기능 설명</h2>
          <p className="mt-2">
          ...
          <p className="mt-2">
            ...
            이라는 회사 소유의 검증된 도메인에 호스팅되어 있으며, 제3자
            플랫폼에서 호스팅되지 않습니다. 이를 통해 사용자는 신뢰할 수 있는
            환경에서 서비스를 이용할 수 있습니다.
          </p>
          ...
          <p className="mt-2">
            ...
            로그인 없이도 접근 가능하도록 공개되어 있습니다. 사용자는 언제든지
            이 페이지를 통해 개인정보 처리방침을 확인할 수 있습니다.
          </p>
          ...
          <p className="mt-2">
            ...
            대하여 "동의" 버튼 또는 "취소" 버튼을 클릭할 수 있는 절차를
            마련하여, "동의" 버튼을 클릭하면 개인정보 수집에 동의한 것으로
            봅니다.
          </p>
          ...
          <p className="mt-2">
            ① "개인정보"라 함은 생존하는 개인에 관한 정보로서 해당 정보에
            포함되어 있는 성명, 생년월일 등의 사항에 의해 특정 개인을 식별할 수
            있는 정보를 의미합니다.
          </p>
          <p className="mt-2">
            ② 개인회원에 대해 수집하는 개인정보 항목과 수집 및 이용 목적은
            다음과 같습니다:
          </p>
          ...
          <p className="mt-2 pl-4">
            <strong>선택 수집 항목:</strong> 주소, 회원제 서비스 이용에 따른
            본인 확인 절차, IP Address.
          </p>
          ...
          <p className="mt-2">
            ...
            다만, 이용자가 탈퇴를 요청하거나 수집 목적이 달성된 경우, 회사는
          ...
          <p className="mt-2">
            ...
            찾아냅니다. 쿠키 사용 목적은 방문한 서비스 및 웹 사이트 이용 형태
            파악 등을 통해 맞춤형 서비스를 제공하는 것입니다.
          </p>
          <p className="mt-2">
          ...
          <p className="mt-2">
            회사는 이용자의 개인정보 보호를 위해 다음과 같은 기술적/관리적
            대책을 시행하고 있습니다:
          </p>
          <p className="mt-2 pl-4">
