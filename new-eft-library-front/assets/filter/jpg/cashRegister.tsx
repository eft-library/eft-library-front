...
export default function CashRegister({ x, y, scale }: JPG) {
  return (
    <>
      ...
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="15.68 13.14 14.25 13.14 14.25 14.14 15.77 14.14 15.68 13.14" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="18.06 13.14 16.68 13.14 16.8 14.14 18.26 14.14 18.06 13.14" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="20.28 13.14 18.92 13.14 19.19 14.14 20.59 14.14 20.28 13.14" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="14.21 16.82 14.2 17.84 16.13 17.84 16.03 16.82 14.21 16.82" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="17.11 16.82 17.23 17.84 18.97 17.84 18.77 16.82 17.11 16.82" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="21.41 16.82 19.88 16.82 20.15 17.84 21.71 17.84 21.41 16.82" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="15.85 14.99 14.23 14.99 14.23 15.98 15.95 15.98 15.85 14.99" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="18.42 14.99 16.89 14.99 17.01 15.98 18.61 15.98 18.42 14.99" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
        <path points="20.85 14.99 19.43 14.99 19.7 15.98 21.14 15.98 20.85 14.99" />
      </g>
      <g transform={`translate(${x}, ${y}) scale(${scale})`}>
