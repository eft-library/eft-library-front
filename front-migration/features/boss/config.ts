...
export function getBossPageCopy(locale: Locale) {
  return {
    ...
    photoLabel: bossUiCopy.photoLabel[locale],
    nameLabel: bossUiCopy.nameLabel[locale],
    factionLabel: bossUiCopy.factionLabel[locale],
    locationLabel: bossUiCopy.locationLabel[locale],
    spawnRateLabel: bossUiCopy.spawnRateLabel[locale],
