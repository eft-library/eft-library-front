...
const PmcExtraction = (props) => {
  return (
    <svg
      ...
      xmlSpace="preserve"
    >
      <style type="text/css">{`.st0{fill:${props.border ? props.border : '#010101'};}.st1{fill:${ITEM_COLOR.PMC_EXTRACTION};}`}</style>
      <g>
