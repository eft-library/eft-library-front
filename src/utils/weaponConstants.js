export const WEAPON_TYPE = [
  ...
  { value: 'Sniper rifle', desc_kr: '경기관총', desc_en: '경기관총' },
  { value: 'Revolver', desc_kr: '기관단총', desc_en: '기관단총' },
  { value: 'SMG', desc_kr: '볼트액션 소총', desc_en: '볼트액션 소총' },
  {
  ...
  { value: 'Machinegun', desc_kr: '거치식 화기', desc_en: '거치식 화기' },
  { value: '12', desc_kr: '근접 무기', desc_en: '근접 무기' },
  { value: '13', desc_kr: '투척 무기', desc_en: '투척 무기' },
  { value: '14', desc_kr: '특수 무기', desc_en: '특수 무기' },
];
