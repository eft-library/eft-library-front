...
module.exports = {
  siteUrl: "https://eftlibrary.com", // .게시하는 site의 url
    ...
    policies: [
      {
        ...
        disallow: [
          "/user", // user 시작하는 페이지 주소 크롤링 금지
        ],
      },
      // 추가 정책이 필요할 경우 배열 요소로 추가 작성
    ],
    additionalSitemaps: ["https://eftlibrary.com/server-sitemap-index.xml"],
  }, // robots.txt 옵션 설정
};
