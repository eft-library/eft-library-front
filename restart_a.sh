...
# 작업 디렉토리로 이동
cd /home/frontend_a/eft-library-front

# .next 디렉토리와 빌드를 삭제
rm -rf /home/frontend_a/eft-library-front/.next/
...
# 백그라운드에서 애플리케이션 시작
/usr/bin/nohup PORT=4001 /usr/bin/npm run start --prefix /home/frontend_a/eft-library-front > /home/frontend_a/eft-library-front/log.out 2>&1 &
