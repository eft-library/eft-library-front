...
import { ContainerTableTypes } from "../container.types";
...
export default function ContainerTable({
  ...
  const filteredList = containerList.filter((item) =>
              ...
              <div className="col-span-1 flex justify-center">
                <div className="relative group">
                  <Image
                    ...
                    width={120}
                    height={120}
                    className="w-32 h-30 object-contain rounded-lg border border-border bg-background group-hover:scale-105 transition-transform duration-200"
                  />
                </div>
              </div>
