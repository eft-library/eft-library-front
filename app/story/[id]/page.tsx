...
export async function generateMetadata({
  ...
  return {
    title: `타르코프 스토리 ${res.name.ko} - EFT Library`,
    description: `Escape from Tarkov(타르코프)의 플레이 스토리를 흐름 중심으로 정리한 가이드입니다. ${res.name.ko} 선행 조건, 목표, 진행 가이드를 통해 스토리 분기와 전체 루트를 한눈에 파악할 수 있습니다.`,
    openGraph: {
      title: `타르코프 스토리 ${res.name.ko} - EFT Library`,
      description: `Escape from Tarkov(타르코프)의 플레이 스토리를 흐름 중심으로 정리한 가이드입니다. ${res.name.ko} 선행 조건, 목표, 진행 가이드를 통해 스토리 분기와 전체 루트를 한눈에 파악할 수 있습니다.`,
      images: [],
