          ...
          >
              ...
              <div className="hidden md:block space-y-2 max-h-40 overflow-y-auto pr-2 w-full">
                {craft.req_item.map((reqItem, index) => (
                  ...
                  >
                    ...
                    <span className="text-xs dark:text-white text-dark flex-grow-0">
                      {reqItem.item[getOtherLocalizedKey(localeKey)]}
                    </span>
                    <span className="text-xs dark:text-white text-dark flex-shrink-0">
                      ×{reqItem.quantity}
                    </span>
                  </div>
                ))}
            ...
            <div className="w-full">
              ...
              <div className="hidden md:flex items-center gap-2 justify-center w-full flex-nowrap">
                ...
                <span className="text-sm font-semibold dark:text-white text-dark flex-shrink-0">
                  &nbsp;×{craft.quantity}
                </span>
              </div>
            </div>
