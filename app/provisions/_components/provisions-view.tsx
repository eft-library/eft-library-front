...
import type { ProvisionsViewTypes } from "./provisions.types";
import ProvisionsTable from "./ProvisionsTable/provisions-table";
    ...
    <ViewWrapper>
      <div className="container mx-auto px-4 py-4 sm:py-8 space-y-6 sm:space-y-8 max-w-7xl">
        <div className="text-center mb-4">
          ...
          <ProvisionsTable provisionsList={provisionsList} word={word} />
        </div>
      </div>
    </ViewWrapper>
  );
