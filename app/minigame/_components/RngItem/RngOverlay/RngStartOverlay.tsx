  ...
  return (
    <div className="absolute inset-0 bg-gradient-to-br from-white/80 via-white/70 to-white/80 dark:from-black/70 dark:via-black/60 dark:to-black/70 backdrop-blur-sm flex items-center justify-center z-20">
      <div className="relative">
        ...
        <div className=" relative w-[320px] max-w-[90vw] min-h-[300px] bg-gradient-to-b ">
          <div className="text-center space-y-6 flex flex-col">
            ...
            <button
              ...
              className="cursor-pointer group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:from-emerald-400 hover:to-emerald-500 transition-all duration-300 hover:scale-105 active:scale-95 items-center justify-center"
            >
