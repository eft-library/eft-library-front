...
import { KeyViewTypes } from "./key.types";
import KeyTable from "./KeyTable/key-table";
import { useState } from "react";
import { Input } from "@/components/ui/input";
import { Search } from "lucide-react";
import ViewWrapper from "@/components/custom/ViewWrapper/view-wrapper";

export default function KeyView({ keyList }: KeyViewTypes) {
    ...
    <ViewWrapper>
      <div className="container mx-auto px-4 py-4 sm:py-8 space-y-6 sm:space-y-8 max-w-6xl">
        <div className="text-center mb-4">
          ...
          <KeyTable keyList={keyList} word={word} />
        </div>
      </div>
    </ViewWrapper>
  );
