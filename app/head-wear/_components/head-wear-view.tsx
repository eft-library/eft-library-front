...
import { HeadWearViewTypes } from "./head-wear.types";
import HeadWearTable from "./HeadWearTable/head-wear-table";
import { useState } from "react";
import { Input } from "@/components/ui/input";
import { Search } from "lucide-react";

export default function HeadWearView({ headWearData }: HeadWearViewTypes) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-4 sm:py-8 space-y-6 sm:space-y-8 max-w-6xl">
        ...
        <HeadWearTable headWearData={headWearData} word={word} />
      </div>
    </div>
  );
}
