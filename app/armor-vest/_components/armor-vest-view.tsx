...
import type { ArmorVestViewTypes } from "./armor-vest.types";
...
export default function ArmorVestView({ armorVestList }: ArmorVestViewTypes) {
    ...
    <ViewWrapper>
      <div className="container mx-auto px-4 py-4 sm:py-8 space-y-6 sm:space-y-8 max-w-7xl">
        <div className="text-center mb-4">
          ...
          <ArmorVestTable armorVestList={armorVestList} word={word} />
        </div>
      </div>
    </ViewWrapper>
  );
