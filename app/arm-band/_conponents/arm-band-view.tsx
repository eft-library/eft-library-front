...
import type { ArmBandViewTypes } from "./arm-band.types";
...
export default function ArmBandView({ armBandList }: ArmBandViewTypes) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-4 sm:py-8 space-y-6 sm:space-y-8 max-w-6xl">
        ...
        <ArmBandTable armBandList={armBandList} word={word} />
      </div>
    </div>
  );
}
