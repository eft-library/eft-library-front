...
import type { HeadsetViewTypes } from "./headset.types";
import HeadsetTable from "./HeadsetTable/headset-table";
...
export default function HeadsetView({ headsetList }: HeadsetViewTypes) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-4 sm:py-8 space-y-6 sm:space-y-8 max-w-6xl">
        ...
        <HeadsetTable headsetList={headsetList} word={word} />
      </div>
    </div>
  );
}
