...
export default function HeadsetTable({ headsetList }: HeadsetListTypes) {
  const locale = useLocale();
  const localeKey = getLocaleKey(locale);
  const columns = [
    { key: "photo", colSpan: 1, colText: itemI18N.headset.photo[localeKey] },
    { key: "name", colSpan: 1, colText: itemI18N.headset.name[localeKey] },
  ];
  return (
